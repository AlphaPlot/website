...
$ccount_settings['admin_pass']='immunology1';

// URL of the click.php file
$ccount_settings['click_url']='http://alphaplot.sourceforge.net/download-counter/click.php';
